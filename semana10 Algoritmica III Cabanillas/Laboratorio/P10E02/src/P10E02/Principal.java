...
public class Principal extends javax.swing.JFrame {
    ...
    protected ArregloPersonasH aph;

    public Principal() {
        initComponents();
        aph = new ArregloPersonasH();
        setSize(637, 311);
    }
    ...
    private void btnnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnuevoActionPerformed
        ...
        if (t != null) {
            JOptionPane.showMessageDialog(this, "DNI repetida");
        } else {
    ...
    public void lista() {
        ...
        for (int i = 0; i < aph.getN(); i++) {
            ...
            imprime(t.getDni() + "\t"
                    ...
                    + t.getEmail() + "\t"
                    + t.getFoto());
        lblImagen.setIcon(new ImageIcon(getClass().getResource("/fotos/" + t.getFoto())));
        }
    }
